/* Cleans up schema. Test purposes only
DROP SCHEMA IF EXISTS FISH_FEEDER CASCADE;
DROP TABLE IF EXISTS USERS, TANKS, FISH, HISTORY;*/
...
INSERT INTO USERS (NAME, EMAIL, TANK_ID, ADMIN) VALUES('PODGE', 'poraich@gmail.com', 1, false);
INSERT INTO USERS (NAME, EMAIL, TANK_ID, ADMIN) VALUES('BARRY', 'barryquigg@gmail.com', 1, false);
